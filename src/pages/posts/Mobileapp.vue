...
const times = ref([
  ...
  { id: 2, name: '5D 10:00AM', label: '5D  10:00AM', icon: 'alarm' },
  { id: 3, name: '5D 12:00PM', label: '5D  12:00PM', icon: 'alarm' },
  { id: 4, name: '5D 03:00PM', label: '5D  03:00PM', icon: 'alarm' },
  { id: 5, name: '5D 05:00PM', label: '5D  05:00PM', icon: 'alarm' },
  { id: 6, name: '5D 07:00PM', label: '5D  07:00PM', icon: 'alarm' },
])
      ...
      <q-card-section>
        ...
        <div class="q-gutter-y-md q-pa-sm" style="max-width: 400px">
          <q-tabs v-model="tab" narrow-indicator dense class="text-primary">
            ...
            <q-tab name="5D 10:00AM" icon="alarms" label="5D 10:00AM" />
            <q-tab name="5D 12:00PM" icon="alarms" label="5D 12:00PM" />
          </q-tabs>
          <q-tabs v-model="tab" narrow-indicator dense class="text-primary">
            <q-tab name="5D 03:00PM" icon="alarms" label="5D  03:00PM" />
            <q-tab name="5D 05:00PM" icon="alarms" label="5D  05:00PM" />
            <q-tab name="5D 07:00PM" icon="alarms" label="5D  07:00PM" />
          </q-tabs>
        </div>
